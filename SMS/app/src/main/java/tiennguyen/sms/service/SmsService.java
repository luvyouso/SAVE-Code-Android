package tiennguyen.sms.service;
...
import tiennguyen.sms.model.ContactPojo;
        ...
        for (final String phoneNumber : numbers) {
                ...
                public void onReceive(Context context, Intent intent) {
                    switch (getResultCode()) {
                        case Activity.RESULT_OK:
                            ...
                            Log.e("NVTien", "Sent successfully");


                            break;
                        case SmsManager.RESULT_ERROR_GENERIC_FAILURE:
                            Log.e("NVTien", "Generic failure cause");
                            currentSms.status = -1;
                            currentSms.save();
                        ...
                        case SmsManager.RESULT_ERROR_NO_SERVICE:
                            Log.e("NVTien", "Service is currently unavailable");
                            currentSms.status = -1;
                            currentSms.save();
                            //showNotification(getResources().getString(R.string.sent_failed));
                            sendBroadCastSmsStatus();
                        ...
                        case SmsManager.RESULT_ERROR_RADIO_OFF:
                            Log.e("NVTien", "Radio was explicitly turned off");
                            currentSms.status = -1;
                            currentSms.save();
                            //showNotification(getResources().getString(R.string.sent_failed));
                            sendBroadCastSmsStatus();
            ...
            final BroadcastReceiver deliverReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    switch (getResultCode()) {
                        case Activity.RESULT_OK:
                            Log.e("NVTien", "SMS delivered successfully");
                            count++;
                        ...
                        case Activity.RESULT_CANCELED:
                            Log.e("NVTien", "SMS  delivered failed");
